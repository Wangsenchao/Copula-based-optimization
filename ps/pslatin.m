% lncorn20=xlsread('pscollect.xlsx','w20','A:A');%数据读取
% lncorn25=xlsread('pscollect.xlsx','w25','A:A');%
% lnrice20=xlsread('pscollect.xlsx','ww20','A:A')
lnrice25=xlsread('pscollect.xlsx','ww25','A:A')
