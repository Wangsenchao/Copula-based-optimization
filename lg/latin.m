% lncorn20=xlsread('lgcollect.xlsx','w20','A:A');%数据读取
% lncorn25=xlsread('lgcollect.xlsx','w25','A:A');%
% lnrice20=xlsread('lgcollect.xlsx','ww20','A:A')
lnrice25=xlsread('lgcollect.xlsx','ww25','A:A')
