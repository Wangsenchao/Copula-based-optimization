%Guangzhou
A=xlsread('gm.xlsx','ww','B:B');%GDP
B=xlsread('gm.xlsx','ww','A:A');%en
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%gz20
...
beef3=beef1(pb2);
beef4=beef2(pb2);
xlswrite('gmcollect.xlsx',beef3,'ww20','A1');%en
xlswrite('gmcollect.xlsx',beef4,'ww20','B1');%gdp/yuan
...
beef3=beef1(pb2);
beef4=beef2(pb2);
xlswrite('gmcollect.xlsx',beef3,'ww25','A1');%en
xlswrite('gmcollect.xlsx',beef4,'ww25','B1');%gdp/yuan
