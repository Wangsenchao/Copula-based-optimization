% lncorn20=xlsread('dpcollect.xlsx','w20','A:A');%数据读取
% lncorn25=xlsread('dpcollect.xlsx','w25','A:A');%
% lnrice20=xlsread('dpcollect.xlsx','ww20','A:A')
lnrice25=xlsread('dpcollect.xlsx','ww25','A:A')
