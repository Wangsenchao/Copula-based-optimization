% lncorn20=xlsread('bacollect.xlsx','w20','A:A');%数据读取
% lncorn25=xlsread('bacollect.xlsx','w25','A:A');%
% lnrice20=xlsread('bacollect.xlsx','ww20','A:A')
lnrice25=xlsread('bacollect.xlsx','ww25','A:A')
...
xlswrite('latin.xlsx',lnww25','25ww','A1');