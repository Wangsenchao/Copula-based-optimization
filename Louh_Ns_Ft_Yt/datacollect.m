%Guangzhou
A=xlsread('tq.xlsx','w12530','B:B');%GDP
B=xlsread('tq.xlsx','w12530','A:A');%en
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%gz20
pb=find(A>142898106 & A<203676500.7);%2020
beef1=B(pb);
beef2=A(pb);
pb2=find(beef1>0);
beef3=beef1(pb2);
beef4=beef2(pb2);
xlswrite('tqcollect1.xlsx',beef3,'w20','A1');%en
xlswrite('tqcollect1.xlsx',beef4,'w20','B1');%gdp/yuan

pb=find(A>203676500.7 & A<267925405.7);%2025
beef1=B(pb);
beef2=A(pb);
pb2=find(beef1>0);
beef3=beef1(pb2);
beef4=beef2(pb2);
xlswrite('tqcollect1.xlsx',beef3,'w25','A1');%en
xlswrite('tqcollect1.xlsx',beef4,'w25','B1');%gdp/yuan
